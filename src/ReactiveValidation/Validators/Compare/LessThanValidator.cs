...
{
    /// <summary>
    /// Validator which check that property value is less than specified value.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="LessThanValidator{TObject,TProp,TParam}" /> class.
        /// </summary>
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="LessThanValidator{TObject,TProp}" /> class.
        /// </summary>
        /// <param name="valueToCompareExpression">Expression of value to compare.</param>
        /// <param name="comparer">The values comparer.</param>
        /// <param name="validationMessageType">Type of validation message.</param>
